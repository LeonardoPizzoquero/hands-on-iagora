...
Define o modelo de dados de likes em posts e comentários, a ação de alternar (toggle) like, a exposição da contagem e do estado "curtido por mim", a proibição de curtir o próprio conteúdo, e as policies de RLS por operação.
